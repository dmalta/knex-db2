...
class Db2QueryCompiler extends QueryCompiler {
  ...
  // Only override methods that actually need DB2-specific behavior
  // All other methods (insert, update, delete, orderBy, groupBy, having, join, where)
  // inherit default behavior from base QueryCompiler
}
